...
$config['settings']['payment']['paypal-sandbox-return_url'] = 'https://reseller.arms-fnb.com/index.php';
//$config['settings']['payment']['paypal-sandbox-notify_url'] = 'http://maximus.ddns.my:3291/ipn.php';
$config['settings']['payment']['paypal-sandbox-notify_url'] = 'https://cloud.arms-fnb.com/ipn.php';
