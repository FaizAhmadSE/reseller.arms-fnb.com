...
$config['maildomain'] = 'armspos.tk';
$config['mailsender'] = 'admin@armspos.tk';
$config['mailfooter'] = "\n\n\n----------------------------\nSee you soon!";
...
$config['settings']['payment']['paypal-sandbox-return_url'] = 'https://reseller.armspos.tk/index.php';
//$config['settings']['payment']['paypal-sandbox-notify_url'] = 'http://maximus.armspos.tk:3291/ipn.php';
$config['settings']['payment']['paypal-sandbox-notify_url'] = 'https://cloud.armspos.tk/ipn.php';
...
$config['settings']['payment']['paypal']['return_url'] = 'https://reseller.armspos.tk/index.php';
$config['settings']['payment']['paypal']['notify_url'] = 'https://cloud.armspos.tk/ipn.php';
...
if((strstr($_SERVER['HTTP_HOST'],'maximus')) || strstr($_SERVER['HTTP_HOST'],'10.1.1.200')){
  ...
  $config['api_path'] = "https://cloud.armspos.tk/";
}
